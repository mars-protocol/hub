...
var (
	pattern_Query_Balances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"mars", "safetyfund", "v1", "balances"}, "", runtime.AssumeColonVerbOpt(false)))
)
