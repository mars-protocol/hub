...
var (
	...
	ErrInvalidProposalIds              = sdkerrors.Register(ModuleName, 5, "invalid incentives proposal ids")
	ErrInvalidProposalStartEndTimes    = sdkerrors.Register(ModuleName, 6, "invalid incentives proposal start and end times")
)
