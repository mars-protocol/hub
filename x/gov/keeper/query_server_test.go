...
func TestQueryServer(t *testing.T) {
	...
	// query votes - for this one we use the vanilla logic
	{
		...
		require.Equal(t, govv1.WeightedVoteOption{Option: govv1.OptionNo, Weight: "1"}, res.Vote.Options[0])
	}
	...
	// query tally result - this one is replaced with our custom logic
	{
		...
		require.NoError(t, err)
		require.Equal(t, "49", res.Tally.YesCount)
		require.Equal(t, "51", res.Tally.NoCount)
